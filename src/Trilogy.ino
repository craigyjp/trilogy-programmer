...
ShiftRegister74HC595<2> sr(33, 32, 31);

RoxButton syncButton;
RoxButton octave1Button;
RoxButton octave2Button;
RoxButton octaveModButton;
RoxButton footSwitch;
...
void setup() {
  ...
  delay(100);
  syncButton.begin();
  syncButton.setDoublePressThreshold(300);
  octave1Button.begin();
  octave1Button.setDoublePressThreshold(300);
  octave2Button.begin();
  octave2Button.setDoublePressThreshold(300);
  octaveModButton.begin();
  octaveModButton.setDoublePressThreshold(300);
  footSwitch.begin();
  footSwitch.setDoublePressThreshold(300);
...
void updateeffect() {
  if (effect) {
    ...
    sr.set(EFFECT_LED, HIGH);  // LED
  } else {
    showCurrentParameterPage("Effects", "Off");
    sr.set(EFFECT_LED, LOW);  // LED
  }
}

void updatesynthInput() {
  if (synthInput) {
    showCurrentParameterPage("Synth FX", "On");
    sr.set(INPUT_A, HIGH);
  } else {
    showCurrentParameterPage("Synth FX", "Bypass");
    sr.set(INPUT_A, LOW);
  }
}

void updateorganInput() {
  if (organInput) {
    showCurrentParameterPage("Organ FX", "On");
    sr.set(INPUT_B, HIGH);
  } else {
    showCurrentParameterPage("Organ FX", "Bypass");
    sr.set(INPUT_B, LOW);
  }
}

void updatestringsInput() {
  if (stringsInput) {
    showCurrentParameterPage("Strings FX", "On");
    sr.set(INPUT_C, HIGH);
  } else {
    showCurrentParameterPage("Strings FX", "Bypass");
    sr.set(INPUT_C, LOW);
  }
}
...
void updateglideMonoMulti() {
  if (glideMonoMulti > 511) {
    ...
    sr.set(GLIDE_MONO_MULTI, HIGH);
  } else {
    showCurrentParameterPage("Glide Enable", String("Mono"));
    sr.set(GLIDE_MONO_MULTI, LOW);
  }
}
  ...
  switch (internal) {
    ...
    case 0:
      switch (effectNumber) {
        ...
        case 2:
          showCurrentParameterPage("Cho/Ens Mix", int(pot2str));
          break;

        case 3:
          showCurrentParameterPage("Feedback", int(pot2str));
          break;

        case 4:
          showCurrentParameterPage("Depth", int(pot2str));
          break;

        case 5:
          showCurrentParameterPage("Ensemble Mix", int(pot2str));
          break;

        case 6:
          showCurrentParameterPage("Filter Freq", int(pot2str));
          break;

        case 7:
          showCurrentParameterPage("Filter Q", int(pot2str));
          break;
      }
      break;
  }
  ...
  switch (internal) {
    ...
    case 0:
      switch (effectNumber) {
        ...
        case 2:
          showCurrentParameterPage("Ensemble", int(pot3str));
          break;

        case 3:
          showCurrentParameterPage("Speed", int(pot3str));
          break;

        case 4:
          showCurrentParameterPage("Rotor Speed", int(pot3str));
          break;

        case 5:
          showCurrentParameterPage("Treble Boost", int(pot3str));
          break;
        ...
        case 7:
          showCurrentParameterPage("Sensitivity", int(pot3str));
          break;
      }
      break;
  }
    ...
    case 1:
      switch (effectNumber) {
        case 0:
          ...
          sr.set(EFFECT_S0, LOW);
          sr.set(EFFECT_S1, LOW);
          sr.set(EFFECT_S2, LOW);
          break;

        case 1:
          FV1effect = "Flange Rev";
          sr.set(EFFECT_S0, HIGH);
          sr.set(EFFECT_S1, LOW);
          sr.set(EFFECT_S2, LOW);
          break;
...
void myControlChange(byte channel, byte control, int value) {
  switch (control) {
    ...
    case CCmix:
      mix = value;
      mixa = map(value, 0, 1023, 0, 627);
      mixb = map(value, 0, 1023, 627, 0);
      mixastr = map(value, 0, 1023, 0, 127);
      mixbstr = map(value, 0, 1023, 127, 0);
      updatemix();
      break;

    case CCinternal:
      internal = map(value, 0, 1023, 1, 0);
      updateinternal();
      break;
...
void setCurrentPatchData(String data[]) {
  ...
  effectNumber = data[49].toInt();
  pot1 = data[50].toInt();
  pot2 = data[51].toInt();
  pot3 = data[52].toInt();
  internal = data[53].toInt();
  synthInput = data[54].toInt();
  organInput = data[55].toInt();
  stringsInput = data[56].toInt();
  mixa = data[57].toInt();
  mixb = data[58].toInt();
...
String getCurrentPatchData() {
  return patchName + "," + String(glideAmount) + "," + String(oscWaveform) + "," + String(octave1) + "," + String(octaveModSW) + "," + String(filterRes) + "," + String(glideSpeed) + "," + String(waveMonoMulti)
         + "," + String(glideDest) + "," + String(glideMonoMulti) + "," + String(ADSRInvert) + "," + String(LfoDelay) + "," + String(filterCutoff) + "," + String(LfoDepth) + "," + String(octave2) + "," + String(sync)
         + "," + String(LfoRate) + "," + String(ampAttack) + "," + String(ampDecay) + "," + String(ampSustain) + "," + String(ampRelease) + "," + String(LFOWaveform) + "," + String(LfoDest) + "," + String(LfoMonoMulti)
         + "," + String(altWave) + "," + String(osc1Detune) + "," + String(LfoSlope) + "," + String(sawtooth) + "," + String(squarewave) + "," + String(LfoVCO) + "," + String(LfoVCF) + "," + String(LfoVCA) + "," + String(glideA)
         + "," + String(glideB) + "," + String(glideC) + "," + String(glideD) + "," + String(organ16) + "," + String(organ8) + "," + String(organ4) + "," + String(organ2) + "," + String(synthVolume) + "," + String(organVolume)
         + "," + String(stringsVolume) + "," + String(timbre) + "," + String(footages) + "," + String(foot16) + "," + String(foot8) + "," + String(stringAttack) + "," + String(stringRelease)
         + "," + String(effectNumber) + "," + String(pot1) + "," + String(pot2) + "," + String(pot3) + "," + String(internal) + "," + String(synthInput) + "," + String(organInput)
         + "," + String(stringsInput) + "," + String(mixa) + "," + String(mixb);
}
...
void checkMux() {
  ...
  if (mux1Read > (mux1ValuesPrev[muxInput] + QUANTISE_FACTOR) || mux1Read < (mux1ValuesPrev[muxInput] - QUANTISE_FACTOR)) {
    ...
    switch (muxInput) {
      ...
      case MUX1_LfoRate:
        if (effect) {
          myControlChange(midiChannel, CCpot1, mux1Read);
        } else {
      ...
      case MUX1_LfoSlope:
        if (effect) {
          myControlChange(midiChannel, CCpot2, mux1Read);
        } else {
      ...
      case MUX1_LfoDepth:
        if (effect) {
          myControlChange(midiChannel, CCmix, mux1Read);
        } else {
...
void writeDemux() {
  ...
  switch (muxOutput) {
    ...
    case 7:
      ...
      break;
    case 8:
      analogWrite(A21, int(pot1));
      break;
    case 9:
      analogWrite(A21, int(pot2));
      break;
    case 10:
      analogWrite(A21, int(pot3));
      break;
    case 11:
      analogWrite(A21, int(mixa));
      break;
    case 12:
      analogWrite(A21, int(mixb));
      break;
    case 13:
      analogWrite(A21, int(0));
      break;
    case 14:
      analogWrite(A21, int(0));
      break;
...
void checkSwitches() {
  ...
  octave1Button.update(digitalRead(OCTAVE1_SW), 50, LOW);
  if (octave1Button.held()) {
    synthInput = !synthInput;
    myControlChange(midiChannel, CCsynthInput, synthInput);
  } else if (octave1Button.released(true)) {
    octave1 = !octave1;
    myControlChange(midiChannel, CCoctave1, octave1);
  }

  octaveModButton.update(digitalRead(OCTAVEMOD_SW), 50, LOW);
  if (octaveModButton.held()) {
    organInput = !organInput;
    myControlChange(midiChannel, CCorganInput, organInput);
  } else if (octaveModButton.released(true)) {
    octaveModSW = !octaveModSW;
    myControlChange(midiChannel, CCoctaveModSW, octaveModSW);
  }

  octave2Button.update(digitalRead(OCTAVE2_SW), 50, LOW);
  if (octave2Button.held()) {
    stringsInput = !stringsInput;
    myControlChange(midiChannel, CCstringsInput, stringsInput);
  } else if (octave2Button.released(true)) {
    octave2 = !octave2;
    myControlChange(midiChannel, CCoctave2, octave2);
  }

  syncButton.update(digitalRead(SYNC_SW), 50, LOW);
  if (syncButton.held()) {
    effect = !effect;
    myControlChange(midiChannel, CCeffect, effect);
  } else if (syncButton.released(true)) {
    sync = !sync;
    myControlChange(midiChannel, CCsync, sync);
  }

  footSwitch.update(digitalRead(FOOTSWITCH), 50, LOW);
